...
void Cube::turn(char *main_face, char *side_face_one, char *side_face_two,
  ...
  side_face_one[0] = buffer[17];
  side_face_one[1] = buffer[18];
  side_face_one[2] = buffer[19];

  side_face_two[0] = buffer[8];
  side_face_two[1] = buffer[9];
  side_face_two[2] = buffer[10];

  side_face_three[0] = buffer[11];
  side_face_three[1] = buffer[12];
  side_face_three[2] = buffer[13];

  side_face_four[0] = buffer[14];
  side_face_four[1] = buffer[15];
  side_face_four[2] = buffer[16];
};
